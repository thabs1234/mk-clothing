...
- portfolio.html   — dedicated portfolio page (linked from index nav)
- styles.css       — brand gold palette (#BB952B etc., real from logo pixels)
